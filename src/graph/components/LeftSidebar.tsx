...
import { ExternalLink, Palette, PanelLeftClose, PanelLeftOpen, SlidersHorizontal } from 'lucide-react'
      ...
      <div className="flex items-center justify-between gap-3 pt-2">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-0.5 text-xs font-medium text-slate-500 transition-colors hover:text-slate-900"
          >
            Docs
