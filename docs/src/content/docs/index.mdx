...
import sizedByAge from '../../assets/quickstart/sized-by-age.png'
...
<Image src={sizedByAge} alt="The same graph, now sized by age. Older users render as larger dots, younger as smaller. The Statistics panel on the right shows the age distribution as a histogram with live quartile readouts." />
