...
import laidOut from '../../assets/quickstart/laid-out.webp'
import colouredCommunity from '../../assets/quickstart/coloured-community.webp'
import sizedByAge from '../../assets/quickstart/sized-by-age.webp'
import filtered from '../../assets/quickstart/filtered.webp'
...
Drop the exported file back into Knotviz anytime and the graph renders exactly where you left it — positions preserved, no re-simulation needed. JSON, CSV pair, and GEXF all round-trip losslessly. The file is standard [Knotviz JSON](/docs/input-formats/json) (or whatever format you picked), so other tools can read it too.
</Aside>
